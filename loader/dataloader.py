...
class SphericalProjectionKitti(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sem_rd_label, proj_sem_rd_label = self.ls.open_label(self.kitti_label_folder / "{0:06d}.label".format(idx))

        sem_label[(sem_label != 0) | (np.isin(sem_rd_label, constants.KITI_ROAD_LABELS))] = 1
        proj_sem_label[(proj_sem_label != 0) | (np.isin(proj_sem_rd_label, constants.KITI_ROAD_LABELS))] = 1
